...
public class YouTubeVideoService {
	...
	public int fetchAndSaveVideos(String query, int maxResults, String category) {
		try {
			...
			log.info("[{}] 영상 저장 완료 - 검색어: {}, 저장: {}/{}", category, query, savedCount, videos.size());
	...
	public List<YouTubeVideo> getVideosByCategoryOrderByLatest(String category, int limit) {
		return youTubeVideoRepository.findByCategoryOrderByPublishedAtDesc(category).stream().limit(limit).toList();
	}
