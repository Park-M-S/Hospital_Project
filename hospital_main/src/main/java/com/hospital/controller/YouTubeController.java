...
public class YouTubeController {
	...
	/**
	 * YouTube API 호출 -> 파싱 -> DB 저장 GET
	 * /youtube/fetch?query=내과&maxResults=10&category=DEPT_내과
	 */
	@GetMapping(value = "/fetch", produces = MediaType.APPLICATION_JSON_VALUE)

	public ResponseEntity<Map<String, Object>> fetchAndSaveVideos(@RequestParam(value = "query") String query,
	...
	/**
	 * 카테고리별 영상 조회 GET /youtube/videos?category=GENERAL
	 */
	@GetMapping(value = "/videos", produces = MediaType.APPLICATION_JSON_VALUE)

	public ResponseEntity<List<YouTubeVideo>> getVideosByCategory(@RequestParam(value = "category") String category) {
	...
	/**
	 * 카테고리별 최신순 영상 조회 (제한) GET /youtube/videos/latest?category=GENERAL&limit=10
	 */
	@GetMapping(value = "/videos/latest", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<YouTubeVideo>> getLatestVideos(@RequestParam(value = "category") String category,
	...
	/**
	 * 영상 상세 조회 GET /youtube/videos/{videoId}
	 */
	 ...
	 * /youtube/videos/page?page=0&size=100&category=GENERAL
	 */
